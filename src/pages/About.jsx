            ...
            <div className='w-full h-auto flex flex-col py-12 lg:flex-row items-center justify-center gap-6'>
                <div className='w-full flex flex-col gap-6'>
                    ...
                    <div className='w-full flex flex-col gap-2'>
                        <p className='font-semibold'>The college operates as an affiliated institution of the Faculty of Engineering and Technology, University of Dhaka. Currently, it has three departments</p>

                        <Link to="/eee">1. Electrical and Electronic Engineering (EEE)</Link>
                        <Link to="/ce">2. Civil Engineering (CE)</Link>
